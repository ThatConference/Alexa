...
module.exports = {
    getWelcomeResponse: () => generalUtils.getRandomItemFromArray([
    ...
    getAboutResponse: () => generalUtils.getRandomItemFromArray([
    ...
    getBaconResponse: () => generalUtils.getRandomItemFromArray([
        "Mmmmm, bacon.",
        "There will be so much bacon.",
        "There's bacon for every breakfast and a bacon bar before the closing keynote."
    ]),
    getHelpResponse: () => generalUtils.getRandomItemFromArray([
        `You can say something like "Tell me about a DevOps session" or "What's today's keynote?"  How can I help?`
    ]),
    getUnknownResponse: () => generalUtils.getRandomItemFromArray([
    ...
    getGoodbyeResponse: () => generalUtils.getRandomItemFromArray([
        "Goodbye, and enjoy That Conference!"
    ]),
    getCodeOfConductResponse: () => generalUtils.getRandomItemFromArray([
    ...
    getCommitmentToDiversityResponse: () => generalUtils.getRandomItemFromArray([
        {
    ...
    getCallForSpeakersResponse: () => generalUtils.getRandomItemFromArray([
        {
    ...
    getTravelInformation: () => generalUtils.getRandomItemFromArray([
        {
